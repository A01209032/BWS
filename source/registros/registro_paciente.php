<?php
    //Este archuvo recibe y verifica los datos de un nuevo paciente y los agrega a la base de datos
    ...
    if($error) echo json_encode($array);
        ...
        if($error!=100) echo json_encode(array("Error: En insercion de base de datos!",$error));
        else echo json_encode(array("Success: Al ingresar datos"));
    }
}
?>
